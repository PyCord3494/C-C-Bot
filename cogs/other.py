...
class Other(commands.Cog):
	...
	async def botinfo(self, ctx):
		...
		embed.add_field(name="Contact Us!", value="For suggestions or to say hi, my developer (<@547475078082985990>) welcomes you to message him!!")
		embed.add_field(name="_ _\nSupport me!", value="If you enjoy me and my features, please consider [Donating](https://www.paypal.me/AutopilotJustin) to the person who developed me. (｡◕‿◕｡)")
